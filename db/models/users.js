...
exports.fetchArticlesByUsername = (username, limit = 10, sort_by = 'created_at', order = 'desc', p) => connection('articles').select('articles.article_id', 'articles.username AS author', 'topic', 'title', 'articles.votes', 'articles.created_at')
