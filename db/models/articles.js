...
exports.changeVote = (article_id, inc_vote) => connection('articles')
  .where('articles.article_id', '=', article_id)
...
exports.fetchCommentsFromArticle = (
  article_id,
  limit = 10,
  sort_by = 'created_at',
  order,
...
exports.createComment = newComment => connection('comments')
  .insert(newComment)
  .returning('*');

exports.addVoteToComment = (article_id, comment_id, inc_vote) => connection('comments')
